 ...
 * @author Juan Bravo
 */
public class PantallaRegistroHuspedes extends javax.swing.JFrame {
     ...
     public PantallaRegistroHuspedes() {
    ...
    private void initComponents() {
        ...
        txtRegistro.setText("REGISTRO HUÉSPED");
        ...
        btnGuardarLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnGuardarLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtGuardar, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void txtGuardarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtGuardarMouseClicked
         ...
         if(nombre.isEmpty() || apellido.isEmpty() || fechaNacimiento == null || nacionalidad.isEmpty() || telefono.isEmpty()){
            ...
            control.guardar(nombre, apellido, telefono,nacimiento,nacionalidad,checkIn,checkOut,valor,formaPago);
        
            MenuUsuario usuario = new MenuUsuario();
            usuario.setVisible(true);
            usuario.setLocationRelativeTo(null);
            mensajeError = new Mensaje("EXITO","Reserva guardada.");
    ...
    private void InputApellidoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_InputApellidoKeyTyped
        if(! (Character.isLetter(evt.getKeyChar())) && ! (evt.getKeyChar() == KeyEvent.VK_SPACE) && ! (evt.getKeyChar() == KeyEvent.VK_DELETE)){
       evt.consume();
        }
